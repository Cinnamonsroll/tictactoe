    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if not end_game:
                m_x, m_y = pygame.mouse.get_pos()
                button_text = END_FONT.render("Restart", 1, White)
                button_rect = pygame.Rect(((WIDTH - button_text.get_width()) // 2) + 10, ((WIDTH - button_text.get_height()) // 2) + 50, button_text.get_width(), button_text.get_height())
